        ...
        <div class="card-body">
            ...
            <form action="#" method="post">
                ...
                <section id="address-patient" class="row">
                    ...
                    <div class="col-6">
                        <div class="form-floating mb-3">
                            <input type="text" name="street" id="street" class="form-control" placeholder="xxxxx-xxx"
                                required>
                    ...
                    <div class="col-6">
                        <div class="form-floating mb-3">
                            <input type="text" name="city" id="city" class="form-control" placeholder="xxxxx-xxx"
                                required>
                    ...
                    <div class="col-6">
                        <div class="form-floating mb-3">
                            <input type="text" name="state" id="state" class="form-control" placeholder="xxxxx-xxx"
                                required>
